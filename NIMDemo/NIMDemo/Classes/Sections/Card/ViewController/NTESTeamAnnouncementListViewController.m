...
@interface NTESTeamAnnouncementListViewController () <UITableViewDelegate, UITableViewDataSource, NTESCreateTeamAnnouncementDelegate> {
...
@implementation NTESTeamAnnouncementListViewController
...
- (void)viewDidLoad {
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"NTESTeamAnnouncementListCell" bundle:nil] forCellReuseIdentifier:@"NTESTeamAnnouncementListCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NTESTeamAnnouncementListCell *cell = [tableView dequeueReusableCellWithIdentifier:@"NTESTeamAnnouncementListCell"];
